...
public class Circles1 {
    ...
    public static void main(String[] args) {
        ...
        new Circles1(data, COUNT, SIZE, SIZE/4);
    }
    ...
    private CirclesPanel1 panel;
    
    
    Circles1(double[] input, int count, int size, double scale) {
        this.size = size;
        this.scale = scale;
        this.input = input;
    ...
    private void initGUI() {
        panel = new CirclesPanel1(scale, input, circles);
